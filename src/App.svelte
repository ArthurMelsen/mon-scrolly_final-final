...
import LoremIpsum from './LoremIpsum.svelte'
  ...
  let observer;
  let scrollyRef;
  let flourishID = "2335256"; // L'ID de la story Flourish
...
<section bind:this={scrollyRef} class="section-container">
  ...
  <div class="sticky-background">
    <!-- On affiche la slide Flourish en fonction de l'index -->
		...
		<p>Source&nbsp;<a href="https://statbel.fgov.be/fr/themes/environnement/economie/depenses-pour-la-protection-de-lenvironnement#figures">Statbel</a></p>
	</div>
